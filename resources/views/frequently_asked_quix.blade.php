                ...
                <ol>
                    <li>
                        <div class="card">
                            ...
                            <div class="card card-header" style="text-transform: capitalize; font-size: 1.3em;">
                ...
                <ol start="4">
                    <li>
                        <div class="card">
                            ...
                            <div class="card card-header" style="text-transform: capitalize; font-size: 1.3em;">
                                Who is eligible to apply for scholarship or bursary?
                            </div>
                    ...
                    <li>
                        ...
                        <div class="card" style="padding-top: 3%;">
                            ...
                            <div class="card card-header" style="text-transform: capitalize; font-size: 1.3em;">
                                When is the scholarship/bursary application open for applicants?
                            </div>
                    ...
                    <li>
                        ...
                        <div class="card" style="padding-top: 3%;">
                            ...
                            <div class="card card-header" style="text-transform: capitalize; font-size: 1.3em;">
                                If approved where do I get my bursary/scholarship cheque?
                            </div>
