    ...
    <div class="container-fluid">
        ...
        <div class="container" id="myform" v-if="this.verified == 1">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text"
                           v-model="application.firstName +' '+application.middleName +' '+application.lastName"
                           readonly class="form-control">
                </div>
                <label class="col-sm-3 col-form-label">REG/ADMISSION NUMBER</label>
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                ...
                <label class="col-sm-1 col-form-label">ID NO</label>
                <div class="col-sm-2">
            ...
            <div class="row form-group">
                ...
                <label class="col-sm-1 col-form-label">WARD</label>
                <div class="col-sm-3">
            ...
            <div class="row form-group">
                ...
                <label class="col-sm-1 col-form-label">VILLAGE</label>
                <div class="col-sm-3">
            ...
            <div class="row form-group">
                ...
                <label class="col-sm-2 col-form-label">YEAR OF STUDY</label>
                <div class="col-sm-2">
            ...
            <div class="row form-group">
                ...
                <label class="col-sm-1 col-form-label">ANNUAL FEES</label>
                <div class="col-sm-2">
                ...
                <label class="col-sm-3 col-form-label">REMAINING BALANCE</label>
                <div class="col-sm-2">
                    <input type="text" v-model="institution.balance" readonly class="form-control">
                </div>
            </div>
            <div class="row">
                <p class="pl-3">(Kindly attach fees structure. First year to attach their calling letter fully
                    stamped)</p>
            </div>
            <div class="row">
            ...
            <div class="row form-group">
                <label class="col-sm-5 col-form-label">HEAD OF INSTITUTION RECOMMENDATION</label>
            ...
            <div class="row form-group">
                <label class="col-sm-3 col-form-label">RECCOMENDATION</label>
                <div class="col-sm-3">
                    <input type="text" readonly class="form-control">
                </div>
                <label class="col-sm-3 col-form-label">NOT RECOMMENDED</label>
                <div class="col-sm-3">
                    <input type="text" readonly class="form-control">
                </div>
            </div>
            <div class="row form-group">
                <label class="col-sm-2 col-form-label">DEFFERED</label>
                <div class="col-sm-3">
                    <input type="text" readonly class="form-control">
                </div>
            ...
            <div class="row form-group">
                <label class="col-sm-1 col-form-label">Approved</label>
                <p class="pt-2">_____________________________________</p>
                <label class="col-sm-2 col-form-label">Not Approved</label>
                <p class="pt-2">______________________________</p>
                <label class="col-sm-1 col-form-label">Deffered</label>
                <p class="pt-2 pl-4">___________________________</p>
            </div>
            <div class="row form-group">
                <label class="col-sm-4 col-form-label">Bursary Awarded in Ksh:</label>
                <div class="col-sm-8">
                    <input type="text" v-model="application.amount" readonly class="form-control">
                </div>
            </div>
            <div class="row form-group">
                <label class="col-sm-3 col-form-label">Reason for Disapproval</label>
                <p class="pt-2 pl-4">
                    ___________________________________________________________________________________</p>
            </div>
            <div class="row form-group">
                <label class="col-sm-1 col-form-label">Chairperson</label>
                <p class="pt-2 pl-4">_____________________________________</p>
                <label class="col-sm-3 col-form-label">Fund Account Manager</label>
            ...
            <div class="row form-group d-flex flex-row-reverse">
                <p class="pt-2 pl-4">_____________________________________</p>
                <label class="col-sm-2 col-form-label">Student Signature</label>
...
<script>
    export default {
        ...
        methods: {
            getApplications() {
                axios.get("/api/form/" + this.serial).then(({data}) => ([this.application = data['application']]));
                axios.get("/api/form/" + this.serial).then(({data}) => ([this.family = data['family']]));
                axios.get("/api/form/" + this.serial).then(({data}) => ([this.morefamily = data['morefamily']]));
                axios.get("/api/form/" + this.serial).then(({data}) => ([this.geographical = data['geographical']]));
                axios.get("/api/form/" + this.serial).then(({data}) => ([this.institution = data['institution']]));
                axios.get("/api/form/" + this.serial).then(({data}) => ([this.verified = data['verified']]));
            },
            print() {
                window.print();
            }
